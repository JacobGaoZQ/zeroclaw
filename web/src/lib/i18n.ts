...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    // A2A Test
    'a2a.title': 'A2A 协议测试',
    'a2a.subtitle': '测试 Agent-to-Agent 协议端点',
    'a2a.target': '目标',
    'a2a.local_gateway': '本地网关',
    'a2a.remote_agent': '远程 Agent',
    'a2a.agent_url_placeholder': 'https://agent.example.com',
    'a2a.bearer_token_placeholder': 'Bearer Token（可选）',
    'a2a.local_bearer_token_placeholder': 'A2A Bearer Token（如已配置则填写）',
    'a2a.action': '操作',
    'a2a.message': '消息内容',
    'a2a.message_placeholder': '发送给 Agent 的消息...',
    'a2a.task_id': '任务 ID',
    'a2a.task_id_placeholder': '粘贴任务 ID...',
    'a2a.task_id_hint': '点击结果卡片上的"使用任务 ID"按钮可自动填充',
    'a2a.run': '执行',
    'a2a.running': '执行中...',
    'a2a.results': '结果',
    'a2a.clear': '清空',
    'a2a.no_results': '执行操作后结果显示在此处',
    'a2a.no_output': '（无输出）',
    'a2a.status_ok': '成功',
    'a2a.status_fail': '失败',
    'a2a.use_task_id': '使用任务 ID',
    'a2a.info_note': 'discover 获取 Agent 能力卡片，send 发送消息并返回任务，status/result 用于查询任务状态和输出。',
  ...
  en: {
    ...
    // A2A Test
    'a2a.title': 'A2A Protocol Tester',
    'a2a.subtitle': 'Test Agent-to-Agent protocol endpoints',
    'a2a.target': 'Target',
    'a2a.local_gateway': 'Local Gateway',
    'a2a.remote_agent': 'Remote Agent',
    'a2a.agent_url_placeholder': 'https://agent.example.com',
    'a2a.bearer_token_placeholder': 'Bearer Token (optional)',
    'a2a.local_bearer_token_placeholder': 'A2A Bearer Token (if configured)',
    'a2a.action': 'Action',
    'a2a.message': 'Message',
    'a2a.message_placeholder': 'Message to send to the agent...',
    'a2a.task_id': 'Task ID',
    'a2a.task_id_placeholder': 'Paste task ID here...',
    'a2a.task_id_hint': 'Click "Use Task ID" on a send result to auto-fill',
    'a2a.run': 'Run',
    'a2a.running': 'Running...',
    'a2a.results': 'Results',
    'a2a.clear': 'Clear',
    'a2a.no_results': 'Run an action to see results here',
    'a2a.no_output': '(no output)',
    'a2a.status_ok': 'OK',
    'a2a.status_fail': 'Failed',
    'a2a.use_task_id': 'Use Task ID',
    'a2a.info_note': 'discover fetches the agent card, send dispatches a message and returns a task, status/result poll task progress and output.',
  ...
  tr: {
    ...
    // A2A Test
    'a2a.title': 'A2A Protokol Test Aracı',
    'a2a.subtitle': 'Agent-to-Agent protokol uç noktalarını test edin',
    'a2a.target': 'Hedef',
    'a2a.local_gateway': 'Yerel Ağ Geçidi',
    'a2a.remote_agent': 'Uzak Ajan',
    'a2a.agent_url_placeholder': 'https://agent.example.com',
    'a2a.bearer_token_placeholder': 'Bearer Token (isteğe bağlı)',
    'a2a.local_bearer_token_placeholder': 'A2A Bearer Token (yapılandırıldıysa)',
    'a2a.action': 'İşlem',
    'a2a.message': 'Mesaj',
    'a2a.message_placeholder': 'Ajana gönderilecek mesaj...',
    'a2a.task_id': 'Görev Kimliği',
    'a2a.task_id_placeholder': 'Görev kimliğini buraya yapıştırın...',
    'a2a.task_id_hint': 'Otomatik doldurmak için gönderme sonucundaki "Görev Kimliğini Kullan" düğmesine tıklayın',
    'a2a.run': 'Çalıştır',
    'a2a.running': 'Çalıştırılıyor...',
    'a2a.results': 'Sonuçlar',
    'a2a.clear': 'Temizle',
    'a2a.no_results': 'Sonuçları görmek için bir işlem çalıştırın',
    'a2a.no_output': '(çıktı yok)',
    'a2a.status_ok': 'Başarılı',
    'a2a.status_fail': 'Başarısız',
    'a2a.use_task_id': 'Görev Kimliğini Kullan',
    'a2a.info_note': 'discover ajan kartını getirir, send bir mesaj gönderir ve görev döndürür, status/result görev ilerlemesini ve çıktısını sorgular.',
